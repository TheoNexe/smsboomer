 ...
 TheoN için Özel SMS Boomer
   by.TheoN
    ...
    if menu == 1:
        ...
        system("cls||clear")
        try:
            print(Fore.LIGHTYELLOW_EX + "entere bas gec email kısmı bura): "+ Fore.LIGHTGREEN_EX, end="")
            mail = input()
        ...
        system("cls||clear")
        print(Fore.RED + " by Theon#5005 Discord üzerinden ulaşabilirsiniz. ")
        print(Fore.GREEN + " Güncel SMS Boomer BİM,A101,Bilet Balıkesir Uludağ , Gofody, Heyapı , İpragaz , Suiste , Buyursungelsin , mopas , dgnonline , english home 'dan Mesajlar Gönderilmektedir.")
        print(Fore.CYAN + "by Theon#5005 Discord üzerinden ulaşabilirsiniz.")
        sleep(12)
    elif menu == 4:
        system("cls||clear")
